...
function playerEntry(eim, player) {
    var map = eim.getMapFactory().getMap(105200810);
...
function scheduledTimeout(eim) {
    eim.disposeIfPlayerBelow(100, 105200810);
    em.setProperty("state", "0");
		em.setProperty("leader", "true");
}

function end(eim) {
    if (eim.disposeIfPlayerBelow(100, 105200810)) {
	em.setProperty("state", "0");
		em.setProperty("leader", "true");
