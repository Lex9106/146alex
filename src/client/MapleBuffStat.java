...
public enum MapleBuffStat implements Serializable, Buffstat {
    ...
    DARKSIGHT(0x400, 1), //d
    BOOSTER(0x800, 1), // d
    POWERGUARD2(0x1000, 1),
    POWERGUARD(0x100000, 8),
    MAXHP(0x2000, 1),
    MAXMP(0x4000, 1),
    ...
    FORBIDDEN_CONTRACT(0x80000000, 2),
    ...
    //4 = unknown
    //0x1?
    GODMODE(0x800000, 3), //Test, it Raises Att at unkown rate
    ELEMENT_RESET(0x2, 3),
    WIND_WALK(0x4, 3),
    //0x8
 ...
 //   MAGIC_RESISTANCE(0x40000, 3),
    ...
    LIGHTNING(0x80, 10),
    ENRAGE(0x4000000, 3), //value is number of mobs hit
    HP_PERCENT(0x20000, 4), //value is number of mobs hit
    ATT(0x900000, 3), //Weapon Att it should be for a skill
    INVENCIBLE(0x200000, 3), //value is number of mobs hit
    OWL_SPIRIT(0x400000, 3),
    //0x800000 debuff, shiny yellow
    FELINE_BERSERK(0x1000000, 3), //value is number of mobs hit
    ...
    GIANT_POTION(0x6000000, 4),
    //GIANT_POTION(0x30000000, 4), Speed Reduce
    ...
    ANGEL(0x100, 9),// Critical Rate
    //Test
    ANGEL_ATK(1024, 5, true),
    ANGEL_MATK(2048, 5, true),
    HPrecoverFamiliar(0x4, 5),
    SPEED2(0x1200000, 5),
    MPrecoverFamiliar(0x200000, 6),
    MAXHP_PERCENT(0x60000000, 5),
    CRITICAL_RATE2(0x400000, 5),
    //CRITICAL_RATE2(4096, 5, true),
    INTERVAL(0x4000000, 5),
    //16384 Weapon and magic accuracy
    //8192 == MaxMPLocal
    //8 unknown tornado debuff? - hp
    INDIE_PAD(0x400, 5, true), // indiePad
    ANGELICBLESSING(0x2000000, 5), // indiePad
    INDIE_MAD(0x800, 5, true),
    CRUSADE_POT(0x1000, 5, true), //0x4000 - 142 - weapon acc/magic acc pct boost
    ...
    DARK_AURA2(0x1000, 6),//
    BARREL_ROLL(0x1000, 6),//Activates Equilibrium
    DAMAGE_R(0x200, 6),
    MDEF_BOOST(0x2000, 6),
    WDEF_BOOST(0x4000, 6),
 ...
 //   HAYATO_STANCE(0x100, 12),
    ...
    private MapleBuffStat(int buffstat, int first) {
        ...
        this.first = first;
        //System.out.println("Detected Buffstats are " + name());
    }
    ...
    private MapleBuffStat(int buffstat, int first, boolean stacked) {
        ...
        //this.stacked = name().contains("INDIE");
        /*if (stacked) {
        System.out.println("Stack Buffstats found are "  + name());    
        }*/
    }
