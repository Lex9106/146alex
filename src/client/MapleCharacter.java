...
import static client.PlayerStats.getSkillBy4thJob;
...
import static handling.channel.handler.InterServerHandler.FamiliarIdLogin;
...
public class MapleCharacter extends AnimatedMapleMapObject implements Serializable, MapleCharacterLook {
    ...
    public int oldValue = 0, orbcount = 0;
    public int Petid, Petid2, Petid3;
    public int acaneAim = 0;
    public int GolluxTries = 0;
    public int MpLightReduce = 0;
    public int Equilibrium = 0;
    public int MpDarkReduce = 0;
    public int DamageTakenLumi = 0;
    ...
    private long lastHPTimeFamiliar, lastMPTimeFamiliar,lastCombo, lastfametime, keydown_skill, nextConsume, pqStartTime, lastDragonBloodTime,
            lastBerserkTime, lastRecoveryTime, lastSummonTime, mapChangeTime, lastFishingTime, lastFairyTime,
            lastHPTimeOverTime, lastMPTimeOverTime, lastHPTime, lastMPTime, lastFamiliarEffectTime, lastExceedTime, lastDOTTime, exp, meso;
    public byte gmLevel, gender, initialSpawnPoint, skinColor, guildrank = 5, allianceRank = 5,
            world, fairyExp, numClones, subcategory, cardStack, runningStack, runningBless = 0;
    private short crescendo, level, job, mulung_energy, combo, force, availableCP, fatigue, totalCP, hpApUsed, scrolledPosition,
    ...
    public int accountid, id, hair, face, secondHair, secondFace, faceMarking, ears, tail, elf, mapid, fame, pvpExp, pvpPoints, totalWins, totalLosses,
            ...
            remainingAp, honourExp, honourLevel, luminousState, starterquest, starterquestid, evoentry;
    private Point old;
    ...
    Map<Integer, MonsterFamiliar> familiars;
    ...
    private boolean petAutoFeed = true; 
    ...
    private MapleCharacter(final boolean ChannelServer) {
        ...
        if (ChannelServer) {
            ...
            lastFishingTime = 0;
            lastFairyTime = 0;
            lastHPTimeFamiliar = 0;
            lastMPTimeFamiliar = 0;
            lastHPTimeOverTime = 0;
            lastMPTimeOverTime = 0;       
            lastHPTime = 0;
            lastMPTime = 0;
...
//            }
    ...
    public void saveToDB(boolean dc, boolean fromcs) {
        ...
        getClient().getSession().close();//Lets try to force to disconect to not get stuck when you exit the game
        getClient().disconnect(true, false);
        resetRunningStack();
        FamiliarIdLogin = 0;
        InterServerHandler.tittleHPMP = 0;
        removeFamiliar();
        if (this.getSkillLevel(70000079) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000079), (byte) -1,(byte) 0); 
        }
        if (this.getSkillLevel(80000133) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(80000133),(byte) -1,(byte) 1);
        }
        if (this.getSkillLevel(80000134) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(80000134),(byte) -1,(byte) 1);
        }
        if (this.getSkillLevel(80000135) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(80000135),(byte) -1,(byte) 1);
        }
        if (this.getSkillLevel(80000136) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(80000136),(byte) -1,(byte) 1);
        }
        if (this.getSkillLevel(70000078) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000078), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000064) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000064), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000072) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000072), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000075) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000075), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000072) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000072), (byte) 0,(byte) 0); 
        }
        ...
        if (this.getSkillLevel(70000073) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000073), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000074) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000074), (byte) 0,(byte) 0); 
        }
        //////////////////////////////////////////////////////////////////////////////
        if (this.getSkillLevel(70000065) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000065), (byte) 0,(byte) 0); 
        this.getStat().recalcLocalStats(this);
        }
        if (this.getSkillLevel(70000066) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000066), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000067) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000067), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000068) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000068), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000069) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000069), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000070) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000070), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000071) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000071), (byte) 0,(byte) 0); 
        }
        acaneAim = 0;
        changeSkillLevel(SkillFactory.getSkill(70000063), (byte) 0,(byte) 0); 
        changeSkillLevel(SkillFactory.getSkill(70000063), (byte) 0,(byte) 0); 
        SkillFactory.getSkill(35121005).getEffect(getTotalSkillLevel(35121005)).applyTo(this);
        changeSkillLevel(SkillFactory.getSkill(70000031), (byte) 0,(byte) 0);
        changeSkillLevel(SkillFactory.getSkill(70000014), (byte) 0,(byte) 0);
        //
        if (this.getSkillLevel(70000072) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000072), (byte) 0,(byte) 0); 
        }
    ...
    public void registerEffect(MapleStatEffect effect, long starttime, ScheduledFuture<?> schedule, Map<MapleBuffStat, Integer> statups, boolean silent, final int localDuration, final int cid) {
        ...
        if (getBuffedValue(MapleBuffStat.INDIE_PAD) != null) {
             int newValue = getBuffedValue(MapleBuffStat.INDIE_PAD);
             this.setBuffedValue(MapleBuffStat.INDIE_PAD, newValue + oldValue);
            }
        /*if (getBuffedValue(MapleBuffStat.INDIE_PAD) != null) {
        Map<MapleBuffStat, Integer> localstatups = statups, maskedStatups = null;
        localstatups = new EnumMap<>(MapleBuffStat.class);
        localstatups.put(MapleBuffStat.DARK_CRESCENDO, oldValue + NewValue);
    ...
    public void cancelEffect(final MapleStatEffect effect, final boolean overwrite, final long startTime, Map<MapleBuffStat, Integer> statups) {
        ...
        if (effect.isInfinity() && getBuffedValue(MapleBuffStat.INFINITY) != null) { //before
            ...
            if (duration > 0) {
                ...
                return;
            } else if ((effect.getSourceId() == 15001022 && !overwrite || effect.getSourceId() == 27121005) && !overwrite) {
                    acaneAim = 0;
                }
        }
        ...
        if (effect.getSourceId() == 2002052 && overwrite) {
        changeSkillLevel(SkillFactory.getSkill(70000079), (byte) 1,(byte) 0); 
        }
        if (effect.getSourceId() == 2002053 && overwrite) {
        changeSkillLevel(SkillFactory.getSkill(70000079), (byte) 2,(byte) 0); 
        }
        if (effect.getSourceId() == 2002052 && !overwrite) {
        if (this.getSkillLevel(70000079) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000079), (byte) 0,(byte) 0); 
        }
        }
        if (effect.getSourceId() == 2002053 && !overwrite) {
        if (this.getSkillLevel(70000079) > 0) { 
        ...
        if (effect.getSourceId() == 2023258 && !overwrite) {
        if (this.getSkillLevel(70000064) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000064), (byte) 0,(byte) 0); 
        }
        }
        //Angelic
        if (effect.getSourceId() == 2022747 && !overwrite) {
        if (this.getSkillLevel(70000078) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000078), (byte) 0,(byte) 0); 
        }
        }
        if (effect.getSourceId() == 2022823 && !overwrite) {
        if (this.getSkillLevel(70000078) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000078), (byte) 0,(byte) 0); 
        }
        }
        if (effect.getSourceId() == 2022746 && !overwrite) {
        if (this.getSkillLevel(70000078) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000078), (byte) 0,(byte) 0); 
        }
        }
        //End Angelic
        if (effect.getSourceId() == 3101004 && !overwrite) {
        if (this.getSkillLevel(70000072) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000072), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000075) > 0) { 
        ...
        if (effect.getSourceId() == 3201004 && !overwrite) {
        if (this.getSkillLevel(70000072) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000072), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000075) > 0) { 
        ...
        if (effect.getSourceId() == 13101024 && !overwrite) {
        if (this.getSkillLevel(70000072) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000072), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000075) > 0) { 
        ...
        if (effect.getSourceId() == 13101003 && !overwrite) {
        if (this.getSkillLevel(70000072) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000072), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000075) > 0) { 
        ...
        if (effect.getSourceId() == 13121004 && !overwrite) {
        if (this.getSkillLevel(70000073) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000073), (byte) 0,(byte) 0); 
        }
        if (this.getSkillLevel(70000074) > 0) { 
        ...
        //////////////////////////////////////////////////////////////////////////////
        if (effect.getSourceId() == 2023251 && !overwrite) {
        if (this.getSkillLevel(70000065) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000065), (byte) 0,(byte) 0); 
        this.getStat().recalcLocalStats(this);
        }
        }
        if (effect.getSourceId() == 2023252 && !overwrite) {
        if (this.getSkillLevel(70000066) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000066), (byte) 0,(byte) 0); 
        }
        }
        if (effect.getSourceId() == 2023253 && !overwrite) {
        if (this.getSkillLevel(70000067) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000067), (byte) 0,(byte) 0); 
        }
        }
        if (effect.getSourceId() == 2023254 && !overwrite) {
        if (this.getSkillLevel(70000068) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000068), (byte) 0,(byte) 0); 
        }
        }
        if (effect.getSourceId() == 2023255 && !overwrite) {
        if (this.getSkillLevel(70000069) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000069), (byte) 0,(byte) 0); 
        }
        }
        if (effect.getSourceId() == 2023256 && !overwrite) {
        if (this.getSkillLevel(70000070) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000070), (byte) 0,(byte) 0); 
        }
        }
        if (effect.getSourceId() == 2023257 && !overwrite) {
        if (this.getSkillLevel(70000071) > 0) { 
        changeSkillLevel(SkillFactory.getSkill(70000071), (byte) 0,(byte) 0); 
        }
                }
         if (effect.getSourceId() == 27121005 && !overwrite) {
        acaneAim = 0;
                }
        if (effect.getSourceId() == 30018003 && !overwrite) {
        changeSkillLevel(SkillFactory.getSkill(70000063), (byte) 0,(byte) 0); 
        getStat().recalcLocalStats(this);
        }
        if (effect.getSourceId() == 31211004 && !overwrite && this.getBuffedValue(MapleBuffStat.MAXHP) != null && this.getBuffedValue(MapleBuffStat.MAXMP) != null) {
        changeSkillLevel(SkillFactory.getSkill(70000063), (byte) 0,(byte) 0); 
        getStat().recalcLocalStats(this);
        }
        ...
        if (effect.getSourceId() == 31011001 && !overwrite) { //when siege 2 deactivates, missile re-activates
            changeSkillLevel(SkillFactory.getSkill(70000031), (byte) 0,(byte) 0);
        }
        if (effect.getSourceId() == 65121053 && !overwrite) {
        changeSkillLevel(SkillFactory.getSkill(70000014), (byte) 0,(byte) 0);
        }
        if (effect.getSourceId() == 31211004 && !overwrite) {
        getStat().hpRecoverTime = 0;
        getStat().shouldHealHP = 0;
    ...
    public void dispel() {
        if (!isHidden()) {
            ...
            for (MapleBuffStatValueHolder mbsvh : allBuffs) {
                if (!GameConstants.isLuminous(getJob())) {
                if (mbsvh.effect.isSkill() && mbsvh.schedule != null && !mbsvh.effect.isMorph() && !mbsvh.effect.isGmBuff() && !mbsvh.effect.isMonsterRiding() && !mbsvh.effect.isMechChange() && !mbsvh.effect.isEnergyCharge() && !mbsvh.effect.isAranCombo() && !mbsvh.effect.isUndispellable()) {
                    cancelEffect(mbsvh.effect, false, mbsvh.startTime);
                }
                }
                else if (GameConstants.isLuminous(getJob()) && getBuffedValue(MapleBuffStat.RECHARGE) != null && GameConstants.isLuminous(getJob())) {
                if (InterServerHandler.ShadowShellCount == 0 || InterServerHandler.ShadowShellCount == 1 || InterServerHandler.ShadowShellCount == 2) {
                            InterServerHandler.ShadowShellCount ++;
                getClient().getSession().write(EffectPacket.showOwnBuffEffect(27111004, 7, getLevel(), MapleStatEffect.level));
                getMap().broadcastMessage(this, EffectPacket.showBuffeffect(getId(), 27111004, 7, getLevel(), MapleStatEffect.level), false);
                            } 
             if (InterServerHandler.ShadowShellCount == 3) {
             getClient().getSession().write(EffectPacket.showOwnBuffEffect(27111004, 7, getLevel(), MapleStatEffect.level));
                getMap().broadcastMessage(this, EffectPacket.showBuffeffect(getId(), 27111004, 7, getLevel(), MapleStatEffect.level), false);
             InterServerHandler.ShadowShellCount = 0;
             Skill bx;
             bx = SkillFactory.getSkill(27111004);
             int bof = getTotalSkillLevel(bx);
             int Duration = bx.getEffect(bof).getCooldown(this);
             getClient().getSession().write(CField.skillCooldown(27111004, Duration));
             addCooldown(27111004, System.currentTimeMillis(), Duration * 1000);
             cancelEffect(mbsvh.effect, false, mbsvh.startTime);
             cancelEffectFromBuffStat(MapleBuffStat.RECHARGE); 
                            }
                }
                else {
                if (mbsvh.effect.isSkill() && mbsvh.schedule != null && !mbsvh.effect.isMorph() && !mbsvh.effect.isGmBuff() && !mbsvh.effect.isMonsterRiding() && !mbsvh.effect.isMechChange() && !mbsvh.effect.isEnergyCharge() && !mbsvh.effect.isAranCombo() && !mbsvh.effect.isUndispellable()) {
    ...
    public final void handleOrbgain() {
        orbcount = getBuffedValue(MapleBuffStat.COMBO);
        Skill normalcombo;
        Skill advcombo;
    ...
    public void handleOrbconsume(int howmany) {
        ...
        dropMessage(5,"Orb consume is " + howmany);
        EnumMap<MapleBuffStat, Integer> stat = new EnumMap<>(MapleBuffStat.class);
        ...
        client.getSession().write(BuffPacket.giveBuff(1111002, duration, stat, ceffect, this));
        map.broadcastMessage(this, BuffPacket.giveForeignBuff(1111002, stat, ceffect), false);
    }
...
//        System.out.println(start + " | " + end);
    ...
    public void changeSingleSkillLevel(final Skill skill, int newLevel, byte newMasterlevel, long expiration, boolean hyper) {
        ...
        client.getSession().write(CWvsContext.updateSkills(list, hyper));//hyper
        reUpdateStat(hasRecovery, recalculate);
    }
    ...
    public void playerDead() {
        ...
        GolluxTries += 1;
        dropMessage(-1,"Remaining tries : " + (5 - GolluxTries));
        if (GolluxTries == 5) {
        warp(863010000);   
        GolluxTries = 0;  
        }
    ...
    /*public void addMPDemon(int delta) {
        addMPDemon(delta, false);
    }

    public void addMPDemon(int delta, boolean ignore) {
        if ((delta < 0 && GameConstants.isDemonSlayer(getJob())) || !GameConstants.isDemonSlayer(getJob()) || ignore) {
            if (stats.setMp(stats.getMp() + delta, this)) {
                updateSingleStat(MapleStat.MP, stats.getMp());
            }
...
//            client.getSession().write(InventoryPacket.updateSpecialItemUse(item, type == MapleInventoryType.EQUIPPED ? (byte) 1 : type.getType(), this));
    ...
    public void gainMesoAutoDrop(long gain, boolean show, boolean inChat) {
        if (meso + gain < 0L || meso + gain > 9999999999L) {
            client.getSession().write(CWvsContext.enableActions());
            return;
        }
    ...
    public int getGiftLog(String bossid) {
        ...
        try {
            int ret_count = 0;
            PreparedStatement ps;
            ps = con1.prepareStatement("select count(*) from bosslog where accountid = ? and bossid = ? and lastattempt >= subtime(current_timestamp, '12:0:0.0')");
            ps.setInt(1, accountid);
            ps.setString(2, bossid);
            ResultSet rs = ps.executeQuery();
            if (rs.next()) 
    ...
    public int getWelcomeGiftLog(String bossid) {
        Connection con1 = DatabaseConnection.getConnection();
        try {
            int ret_count = 0;
            PreparedStatement ps;
            ps = con1.prepareStatement("select count(*) from bosslog where accountid = ? and bossid = ? and lastattempt >= subtime(current_timestamp, '36500:0:0:0.0')");
            ps.setInt(1, accountid);
            ps.setString(2, bossid);
            ResultSet rs = ps.executeQuery();
            if (rs.next()) 
    ...
    public void autoJob() {
        if (getLevel() > 9 && getLevel() < 30) {
        gainItem(2022700,1);   
        }
        if (getLevel() > 29 && getLevel() < 70) {
        gainItem(2022700,2);   
        }
        if (getLevel() > 69 && getLevel() < 120) {
        gainItem(2022700,3);   
        }
        if (getLevel() > 120 && getLevel() < 201) {
        gainItem(2022700,5);   
        }
        if (getLevel() > 200) {
        gainItem(2022700,10);   
        ...
        //Auto Job
        if ((job >= 430 && job <= 434) || (job == 400 && this.subcategory == 1)) { // Dual Blade
            switch (getLevel()) {
                case 20:
                    changeJob((short) 430);
                    break;
        ...
        else if (GameConstants.isAdventurer(job)) {
            final String base = (String.valueOf(job).substring(0, 2)) + "0"; // Take the first 2 digits		
            if (level == 100 && job % 10 != 2 && job % 100 != 0) {
                changeJob((short) (Integer.valueOf(base) + 2));
            } else if ((level == 60) && job % 10 != 1 && job % 100 != 0) {
                changeJob((short) (Integer.valueOf(base) + 1));
            }
        }
            ...
            if (level >= 100 && job % 10 != 2 && job % 100 != 0) { // Level 120 and above, but not yet 4th job
                changeJob((short) (Integer.valueOf(base) + 12));
            } else if ((level >= 60 && level <= 99) && job % 10 != 1 && job % 100 != 0) { //Stil second job
                changeJob((short) (Integer.valueOf(base) + 11));
            } else if ((level >= 30 && level <= 59) && job % 100 == 0) { // Still first job
            ...
            switch (getLevel()) {
                case 30:
                    ...
                    remainingSp[GameConstants.getSkillBook(job, level)] += 2;
                    break;
                case 60:
        ...
        if (level == 140) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0030, getJob()) + 6), (byte) 1, (byte) 1);
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0031, getJob()) + 6), (byte) 1, (byte) 1);
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0032, getJob()) + 6), (byte) 1, (byte) 1);
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0033, getJob()) + 6), (byte) 1, (byte) 1);
        dropMessage(-6, "Hyper STR/DEX/INT/LUK Hyper Skill has been acquired.");
        }
        if (level == 198) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0034, getJob()) + 6), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0034, getJob()) + 6));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 158) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0035, getJob()) + 6), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0035, getJob()) + 6));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 192) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0036, getJob()) + 6), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0036, getJob()) + 6));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 186) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0037, getJob()) + 6), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0037, getJob()) + 6));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 180) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0037, getJob()) + 7), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0037, getJob()) + 7));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 165) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0037, getJob()) + 8), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0037, getJob()) + 8));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 174) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0037, getJob()) + 9), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0037, getJob()) + 9));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 152) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0037, getJob()) + 10), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0037, getJob()) + 10));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 146) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0037, getJob()) + 11), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0037, getJob()) + 11));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        //Passive Classes
        if (level == 183) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0043, getJob()) + 8), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0043, getJob()) + 8));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (GameConstants.isDemonSlayer(getJob()) && GameConstants.isLuminous(getJob())) {
        if (level == 162) {//0044
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0044, getJob()) + 8), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0044, getJob()) + 8));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 143) {//0045
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0045, getJob()) + 8), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName(getSkillBy4thJob(0045, getJob()) + 8);
        dropMessage(-6, msg + " Skill has been acquired. ");
        }
        }
        else {
        ...
        if (level == 168) {//0046
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0046, getJob()) + 8), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0046, getJob()) + 8));
        dropMessage(-6, msg + " Skill has been acquired.");
        }    
        if (level == 189) {//0047
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0047, getJob()) + 8), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0047, getJob()) + 8));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 149) {//0048
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0047, getJob()) + 9), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0047, getJob()) + 9));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 195) {//0049
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0047, getJob()) + 10), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0047, getJob()) + 10));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 177) {//0050
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0047, getJob()) + 11), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0047, getJob()) + 11));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 155) {//0051
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(0047, getJob()) + 12), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(0047, getJob()) + 12));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 170) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(1052, getJob())), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(1052, getJob())));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 200) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(1053, getJob())), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(1053, getJob())));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (level == 150) {
        changeSkillLevel(SkillFactory.getSkill(getSkillBy4thJob(1054, getJob())), (byte) 1, (byte) 1);
        final String msg = SkillFactory.getSkillName((getSkillBy4thJob(1054, getJob())));
        dropMessage(-6, msg + " Skill has been acquired.");
        }
        if (GameConstants.isKOC(job) && level == 30) {
        addReward(1,1032095, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isJett(job) && level == 30) {
        addReward(1,1132155, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isJett(job) && level == 30) {
        addReward(1,1003550, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isEvan(job) && level == 30) {
        addReward(1,1022117, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isEvan(job) && level == 70) {
        addReward(1,1003645, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isDualBlade(job) && level == 30) {
        addReward(1,1012240, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isDualBlade(job) && level == 120) {
        addReward(1,1012314, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isDualBlade(job) && level == 50) {
        addReward(1,1003479, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isKanna(job) && level == 50 || GameConstants.isHayato(job) && level == 50) {
        addReward(1,1122204, 0, 0, 0, "Congratulations, you've obtained an event item!");
        addReward(1,1003828, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isKanna(job) && level == 50) {
        addReward(1,1003575, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isAran(job) && level == 70) {
        addReward(1,1003644, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isMercedes(job) && level == 70) {
        addReward(1,1003646, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isMercedes(job) && level == 50) {
        addReward(1,1003359, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isDemonSlayer(job) && level == 80) {
        addReward(1,1003734, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isDemonSlayer(job) && level == 30 || GameConstants.isDemonAvenger(job) && level == 30) {
        addReward(1,1099002, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isDemonSlayer(job) && level == 60 || GameConstants.isDemonAvenger(job) && level == 60) {
        addReward(1,1099003, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isDemonSlayer(job) && level == 100 || GameConstants.isDemonAvenger(job) && level == 100) {
        addReward(1,1099004, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
        if (GameConstants.isDemonAvenger(job) && level == 80) {
        addReward(1,1003752, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
         if (GameConstants.isXenon(job) && level == 80) {
        addReward(1,1003753, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
         if (GameConstants.isPhantom(job) && level == 70) {
        addReward(1,1003647, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
         if (GameConstants.isPhantom(job) && level == 50) {
        addReward(1,1003409, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
         if (GameConstants.isMihile(job) && level == 70){
        addReward(1,1003507, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
         if (GameConstants.isLuminous(job) && level == 70) {
        addReward(1,1003648, 0, 0, 0, "Congratulations, you've obtained an event item!");
        updateReward();
        }
    ...
    public void sendPendant(boolean b) {
        getClient().getSession().write(CWvsContext.pendantSlot(b));
    }
    public long getCurrentTime() {
        return System.currentTimeMillis();
    }
    public final void forceStartQuest(final int id, final String data) {
        MapleQuest.getInstance(id).forceStart(this, 0, data);
    }

    public final void forceStartQuest(final int id, final int data, final boolean filler) {
        MapleQuest.getInstance(id).forceStart(this, 0, filler ? String.valueOf(data) : null);
    }

    public void forceStartQuest(final int id) {
        MapleQuest.getInstance(id).forceStart(this, 0, null);
    }
    
    public void addPendantSlot(int days) {
        getQuestNAdd(MapleQuest.getInstance(GameConstants.PENDANT_SLOT)).setCustomData(String.valueOf(System.currentTimeMillis() + ((long) days * 24 * 60 * 60 * 1000)));
    }
    ...
    public void sendSpawnData(MapleClient client) {
        ...
        addPendantSlot(3650);// 10 yrs.
        sendPendant(true);
        dropMessage(-5,"Additional Pendant Slot gained.");
        }
        if (this.getSkillLevel(80000023) == 0) {
        changeSkillLevel(SkillFactory.getSkill(80000023), (byte) 1, (byte) 1);
        }
        if (GameConstants.isKOC(getJob()) && this.getSkillLevel(10000018) == 0) {
                            changeSkillLevel(SkillFactory.getSkill(10000018), (byte) 1, (byte) 1);
                        } else if (GameConstants.isAran(getJob()) && this.getSkillLevel(20000024) == 0) {
                            changeSkillLevel(SkillFactory.getSkill(20000024), (byte) 1, (byte) 1);
                        } else if (GameConstants.isEvan(getJob()) && this.getSkillLevel(20011024) == 0) {
                            changeSkillLevel(SkillFactory.getSkill(20011024), (byte) 1, (byte) 1);
                        } else if (GameConstants.isMercedes(getJob()) && this.getSkillLevel(20021024) == 0) {
                            changeSkillLevel(SkillFactory.getSkill(20021024), (byte) 1, (byte) 1);
                        } else if (GameConstants.isPhantom(getJob()) && this.getSkillLevel(20031024) == 0) {
                            changeSkillLevel(SkillFactory.getSkill(20031024), (byte) 1, (byte) 1);
                        } else if (GameConstants.isDemonSlayer(getJob()) && this.getSkillLevel(30011024) == 0) {
                            changeSkillLevel(SkillFactory.getSkill(30011024), (byte) 1, (byte) 1);
                        } else if (GameConstants.isResist(getJob()) && this.getSkillLevel(30001024) == 0) {
                            changeSkillLevel(SkillFactory.getSkill(30001024), (byte) 1, (byte) 1);
                        } else if (GameConstants.isMihile(getJob()) && this.getSkillLevel(50001018) == 0) {
                            changeSkillLevel(SkillFactory.getSkill(50001018), (byte) 1, (byte) 1);
        ...
        if (GameConstants.isLuminous(getJob()) && this.getSkillLevel(27001100) == 0) {
        changeSkillLevel(SkillFactory.getSkill(27001100), (byte) 0, (byte) 10);
        changeSkillLevel(SkillFactory.getSkill(27001201), (byte) 0, (byte) 10);
        changeSkillLevel(SkillFactory.getSkill(27000106), (byte) 0, (byte) 5);
        changeSkillLevel(SkillFactory.getSkill(27000207), (byte) 0, (byte) 5);      
        }
        ...
        if (eff != null && eff.getInterval() <= 0 && eff.makeChanceResult()) { //i think this is actually done through a recv, which is ATTACK_FAMILIAR +1
            dispelBuff(ii.getFamiliar(summonedFamiliar.getFamiliar()).passive);
            MapleItemInformationProvider.getInstance().getItemEffect(ii.getFamiliar(summonedFamiliar.getFamiliar()).passive).applyTo(this);
            if (ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860199 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860185 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860171 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860157 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860143 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860129 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860115 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860101 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860087 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860073 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860059 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860045 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860031 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300) || ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860003 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300)|| ii.getFamiliar(summonedFamiliar.getFamiliar()).passive == 2860017 && !(getMapId() >= 220000000 && getMapId() <= 220099999) && !(getMapId() >= 221020000 && getMapId() <= 221023300)) {
            dispelBuff(ii.getFamiliar(summonedFamiliar.getFamiliar()).passive);    
            }
            getStat().relocHeal(this);
        }
        ...
        GolluxTries = 0;   
            ...
            if (getMapId() == 141060000) {
            SkillFactory.getSkill(80001298).getEffect(1).applyTo(this);    
            }
            if (getMapId() == 240092400 && getQuestStatus(31348) == 1) {
    ...
    public final void equipChanged() {
        if (map == null) {
         ...
         final Iterator<Item> itera = getInventory(MapleInventoryType.EQUIPPED).newList().iterator();
        while (itera.hasNext()) {
        final Equip equip = (Equip) itera.next();
        if ((equip.getItemId() / 10 == 114232)) {
        this.getMonsterBook().calculateScore(this);
        }
        }
    ...
    public void removePet(MaplePet pet, boolean shiftLeft) {
        pet.setSummoned(0);
        if (this.getSkillLevel(80010003) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80010003), (byte) -1, (byte) 0);
        }
        if (this.getSkillLevel(80010004) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80010004), (byte) -1, (byte) 0);
        }
        if (this.getSkillLevel(80010005) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80010005), (byte) -1, (byte) 0);
        }
        if (this.getSkillLevel(80000007) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80000007), (byte) -1, (byte) 0);
        }
        if (this.getSkillLevel(80000008) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80000008), (byte) -1, (byte) 0);
        }
        if (this.getSkillLevel(80000009) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80000009), (byte) -1, (byte) 0);
        }
        if (this.getSkillLevel(80000072) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80000072), (byte) -1, (byte) 0);
        }
        if (this.getSkillLevel(80000073) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80000073), (byte) -1, (byte) 0);
        }
        if (this.getSkillLevel(80000074) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80000074), (byte) -1, (byte) 0);
        }
    }
    ...
    public void giveCoolDowns(final List<MapleCoolDownValueHolder> cooldowns) {
        ...
        if (cooldowns != null) {
            for (MapleCoolDownValueHolder cooldown : cooldowns) {
                ...
                client.getSession().write(CField.skillCooldown(cooldown.skillId, (int) cooldown.length));
                addCooldown(cooldown.skillId, cooldown.startTime, (int) cooldown.length);
                //applyto.getClient().getSession().write(CField.skillCooldown(27111303, Duration));
                //applyto.addCooldown(27111303, System.currentTimeMillis(), Duration * 1000);
            }
        } else {
            try {
                Connection con = DatabaseConnection.getConnection();
                ...
                try (PreparedStatement ps = con.prepareStatement("SELECT SkillID,StartTime,length FROM skills_cooldowns WHERE charid = ?")) {
                    ...
                    rs = ps.executeQuery();
                    while (rs.next()) {
                        client.getSession().write(CField.skillCooldown(rs.getInt("SkillID"),(rs.getInt("length"))));
                        addCooldown(rs.getInt("SkillID"), rs.getLong("StartTime"), rs.getInt("length"));
                    }
                }
                rs.close();
    ...
    public void ApplyPoison(boolean Cure) {
     final long durationFinal = PoisonDuration;
            ...
            TimerTask timeTask = new TimerTask() {
                ...
                public void run() {
                    if (isAlive() && !Cure)  {
                        addHP((PoisonDamage * getStat().ASR / 100) - PoisonDamage);
                        if (isSuperGM()) {
                        dropMessage(5,"Poison Damage is " + (PoisonDamage - (PoisonDamage * getStat().ASR / 100)));
                        }
                    }  
                    if((runCount.incrementAndGet() >= (durationFinal/1000)) || !isAlive() || Cure){ //When duration is met, or monster is dead, remove the timer. 
                        if (isSuperGM()) {
                        dropMessage(5,"Poison Damage has been cancelled.");
                        } 
                        PoisonDamage = 0;
                        PoisonDuration = 0;
                        DoTTimer.cancel(); //Cancels and cleans up the timer.
                    }
                }
            };
            DoTTimer.schedule(timeTask, 0, 1015);
}
    ...
    public void finishAchievement(int id) {
        if (!achievementFinished(id)) {
            if (isAlive() && !isClone()) {
                ...
                getClient().getSession().write(CField.showEffect("Yut/goal"));
                getClient().getSession().write(CField.playSound("advStory/stoneUse"));
            }
        }
    }
    ...
    public final boolean canHPOverTime(long now) {
        if (lastHPTimeOverTime + 5000 < now) {
            lastHPTimeOverTime = now;
            return true;
        }
        return false;
    }

    public final boolean canMPOverTime(long now) {
        if (lastMPTimeOverTime + 5000 < now) {
            lastMPTimeOverTime = now;
            return true;
        }
        return false;
    }
    public final boolean canHPRecoverFamiliar(long now) {
        if (stats.hpRecoverTimeFamiliar > 0 && lastHPTimeFamiliar + stats.hpRecoverTimeFamiliar < now) {
            lastHPTimeFamiliar = now;
            return true;
        }
        return false;
    }
    
    public final boolean canMPRecoverFamiliar(long now) {
        if (stats.mpRecoverTimeFamiliar > 0 && lastMPTimeFamiliar + stats.mpRecoverTimeFamiliar < now) {
            lastMPTimeFamiliar = now;
            return true;
        }
        return false;
    }
    ...
    public final boolean canSpawnEliteBoss(long now) {
        if (InterServerHandler.EliteBossTime > 0 && InterServerHandler.LastEliteBoss + InterServerHandler.EliteBossTime < now) {
            InterServerHandler.LastEliteBoss = now;
            return true;
        }
        return false;
    }
    
    public final boolean canGiveElunaBless(long now) {
        if (InterServerHandler.ElunaBuffTime > 0 && InterServerHandler.LastElunaBuff + InterServerHandler.ElunaBuffTime < now) {
            InterServerHandler.LastElunaBuff = now;
            dropMessage(5, "" + InterServerHandler.ElunaBuffTime);
            return true;
        }
        return false;
    }
    
    public final boolean canGiveElunaBless2(long now) {
        if (InterServerHandler.ElunaBuffTime2 > 0 && InterServerHandler.LastElunaBuff2 + InterServerHandler.ElunaBuffTime2 < now) {
            InterServerHandler.LastElunaBuff2 = now;
            return true;
        }
        return false;
    }
    
    public final boolean canGiveElunaBless3(long now) {
        if (InterServerHandler.ElunaBuffTime3 > 0 && InterServerHandler.LastElunaBuff3 + InterServerHandler.ElunaBuffTime3 < now) {
            InterServerHandler.LastElunaBuff3 = now;
            return true;
        }
        return false;
    }
    
    public final boolean canGiveElunaBless4(long now) {
        if (InterServerHandler.ElunaBuffTime4 > 0 && InterServerHandler.LastElunaBuff4 + InterServerHandler.ElunaBuffTime4 < now) {
            InterServerHandler.LastElunaBuff4 = now;
            return true;
        }
        return false;
    }
    
    public final boolean canGiveElunaBless5(long now) {
        if (InterServerHandler.ElunaBuffTime5 > 0 && InterServerHandler.LastElunaBuff5 + InterServerHandler.ElunaBuffTime5 < now) {
            InterServerHandler.LastElunaBuff5 = now;
            return true;
        }
        return false;
    }
    
    public final boolean canGiveElunaBless6(long now) {
        if (InterServerHandler.ElunaBuffTime6 > 0 && InterServerHandler.LastElunaBuff6 + InterServerHandler.ElunaBuffTime6 < now) {
            InterServerHandler.LastElunaBuff6 = now;
            return true;
        }
        return false;
    }
    
    public final boolean canGiveElunaBless7(long now) {
        if (InterServerHandler.ElunaBuffTime7 > 0 && InterServerHandler.LastElunaBuff7 + InterServerHandler.ElunaBuffTime7 < now) {
            InterServerHandler.LastElunaBuff7 = now;
            return true;
        }
        return false;
    }
    
    public final boolean canGiveElunaBless8(long now) {
        if (InterServerHandler.ElunaBuffTime8 > 0 && InterServerHandler.LastElunaBuff8 + InterServerHandler.ElunaBuffTime8 < now) {
            InterServerHandler.LastElunaBuff8 = now;
            return true;
        }
        return false;
    }
            ...
            default: {
                ...
                if (pet != null && (item.getItemId() != 5000054 || pet.getSecondsLeft() > 0) && (item.getExpiration() == -1 || item.getExpiration() > System.currentTimeMillis())) {
                    if (pet.getSummoned()) { // Already summoned, let's keep it
                        ...
                        if (getPetIndex(pet) == 0) {
                        Petid = pet.getPetItemId();
                        if (Petid >= 5000369 && Petid <= 5000371) {
                        this.changeSkillLevel(SkillFactory.getSkill(80010003), (byte) 1, (byte) 1);
                        }
                        else {
                            if (this.getSkillLevel(80010003) > 0) {
                            this.changeSkillLevel(SkillFactory.getSkill(80010003), (byte) -1, (byte) 0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                       if (Petid >= 5000234 && Petid <= 5000236 || Petid >= 5000130 && Petid <= 5000132) {
                        this.changeSkillLevel(SkillFactory.getSkill(80010003), (byte) 1, (byte) 1);
                        }
                        else {
                            if (this.getSkillLevel(80000007) > 0) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            if (Petid >= 5000281 && Petid <= 5000283) {
                        this.changeSkillLevel(SkillFactory.getSkill(80000072), (byte) 1, (byte) 1);
                        }
                        else {
                            if (this.getSkillLevel(80000072) > 0) {
                            this.changeSkillLevel(SkillFactory.getSkill(80000072), (byte) -1, (byte) 0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        else if (getPetIndex(pet) == 1) {
                        Petid2 = pet.getPetItemId();    
                        if (Petid >= 5000369 && Petid <= 5000371 && Petid2 >= 5000369 && Petid2 <= 5000371) {
                        this.changeSkillLevel(SkillFactory.getSkill(80010003), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80010004), (byte) 1, (byte) 1);
                        }
                        else {
                        if (this.getSkillLevel(80010003) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80010003), (byte) -1, (byte) 0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                         if (Petid >= 5000234 && Petid <= 5000236 || Petid >= 5000130 && Petid <= 5000132 && Petid2 >= 5000234 && Petid2 <= 5000236 || Petid2 >= 5000130 && Petid2 <= 5000132) {
                        this.changeSkillLevel(SkillFactory.getSkill(80000007), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80000008), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80000009), (byte) 1, (byte) 1);
                        }
                        else {
                            if (this.getSkillLevel(80000007) > 0) {
                            this.changeSkillLevel(SkillFactory.getSkill(80000007), (byte) -1, (byte) 0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if (Petid >= 5000281 && Petid <= 5000283 && Petid2 >= 5000281 && Petid2 <= 5000283) {
                        this.changeSkillLevel(SkillFactory.getSkill(80000072), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80000073), (byte) 1, (byte) 1);
                        }
                        else {
                            if (this.getSkillLevel(80000072) > 0) {
                            this.changeSkillLevel(SkillFactory.getSkill(80000072), (byte) -1, (byte) 0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        else if (getPetIndex(pet) == 2) {
                        Petid3 = pet.getPetItemId();    
                        if (Petid >= 5000369 && Petid <= 5000371 && Petid2 >= 5000369 && Petid2 <= 5000371 && Petid3 >= 5000369 && Petid3 <= 5000371) {
                        this.changeSkillLevel(SkillFactory.getSkill(80010003), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80010004), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80010005), (byte) 1, (byte) 1);
                        }
                        else {
                        if (this.getSkillLevel(80010003) > 0) {
        this.changeSkillLevel(SkillFactory.getSkill(80010003), (byte) -1, (byte) 0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                         if (Petid >= 5000234 && Petid <= 5000236 || Petid >= 5000130 && Petid <= 5000132 && Petid2 >= 5000234 && Petid2 <= 5000236 || Petid2 >= 5000130 && Petid2 <= 5000132 && Petid3 >= 5000234 && Petid3 <= 5000236 || Petid3 >= 5000130 && Petid3 <= 5000132) {
                        this.changeSkillLevel(SkillFactory.getSkill(80000007), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80000008), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80000009), (byte) 1, (byte) 1);
                        }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if (Petid >= 5000281 && Petid <= 5000283 && Petid2 >= 5000281 && Petid2 <= 5000283 && Petid3 >= 5000281 && Petid3 <= 5000283) {
                        this.changeSkillLevel(SkillFactory.getSkill(80000072), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80000073), (byte) 1, (byte) 1);
                        this.changeSkillLevel(SkillFactory.getSkill(80000074), (byte) 1, (byte) 1);
                        }
                        else {
                            if (this.getSkillLevel(80000072) > 0) {
                            this.changeSkillLevel(SkillFactory.getSkill(80000072), (byte) -1, (byte) 0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        System.out.println("Pet " + getPetIndex(pet));
    ...
    public void changeChannel(final int channel) {
        ...
        System.out.println("STORED ALL BUFFS/COOLDOWNS IN CHANGE CHANNEL");
    ...
    public void changeRemoval(boolean dc) {
        ...
        dispelSummons();
        if (getSummonedFamiliar() != null) {
        if (getSummonedFamiliar().getFatigue() >= 300) {
        FamiliarIdLogin = 0;
        }
        else {
        FamiliarIdLogin = getSummonedFamiliar().getFamiliar();
        }
        }
        if (dc) {
        removeFamiliar();    
        ...
        if (!dc) {
            ...
            cancelEffectFromBuffStat(MapleBuffStat.MECH_CHANGE);
            cancelEffectFromBuffStat(MapleBuffStat.RECOVERY);
            cancelEffectFromBuffStat(MapleBuffStat.DARK_METAMORPHOSIS);           
    ...
    public void forceCompleteQuest(int id) {
        ...
        if (id > 10000) {
        getClient().getSession().write(EffectPacket.showForeignEffect(12)); // Quest completion
        getMap().broadcastMessage(this, EffectPacket.showForeignEffect(this.getId(), 12), false);    
        }
    }
    ...
    public void doFamiliarSchedule(long now) {
        ...
        for (MonsterFamiliar mf : familiars.values()) {
            ...
            else if (mf.getFatigue() > 0 && mf.getFatigue() <= 11 && summonedFamiliar.getId() != mf.getId()) {
                dropMessage(-6, mf.getName() +" has been fully recovered and it's ready to fight.");
                mf.setFatigue(0);
                client.getSession().write(CWvsContext.getFamiliarInfo(this));
            }
            if (mf.getFatigue() > 0 && mf.getFatigue() <= 11 && summonedFamiliar == null) {
            dropMessage(-6, mf.getName() +" has been fully recovered and it's ready to fight.");
                mf.setFatigue(0);
                client.getSession().write(CWvsContext.getFamiliarInfo(this));   
            }
    ...
    public Pair<Double, Boolean> modifyDamageTaken(double damage, MapleMapObject attacke) {
        ...
        if (barrier != null) {
             damage = (barrier.getX() * damage / 100.0);
              damage += 1;
        }
        ...
        if (damage > 0 && DamageTakenLumi == 1) {
        Skill skill = SkillFactory.getSkill(27100003);
        int lvl = getTotalSkillLevel(27100003);
        int Value = skill.getEffect(lvl).getX();
        damage *= (1.0d - Value / 100.0d);
        damage += 1;
        DamageTakenLumi = 0;
        }
        ...
        barrier = getStatForBuff(MapleBuffStat.DAMAGE_ABSORBED);
        if (barrier != null) {
            damage *= (1.0d - (barrier.getX() / 100.0d));
        }
        ...
        if (damage > 0) {
            ...
            if (attacke != null) {
                ...
                final int bouncedam_ = (getBuffedValue(MapleBuffStat.POWERGUARD) != null ? getBuffedValue(MapleBuffStat.POWERGUARD) : (getBuffedValue(MapleBuffStat.DAMAGE_ABSORBED) != null && this.getJob() >= 111 ? 500 : 0));
                final MapleMonster attacker = (MapleMonster) attacke;
                if (bouncedam_ > 0) {
                    long bouncedamage = (long) (damage * bouncedam_ / 100);
                    if (attacke instanceof MapleMonster) {
                        getMap().broadcastMessage(this, MobPacket.damageMonster(attacke.getObjectId(), bouncedamage), true);
                        getClient().getSession().write(CField.playSound("Cokeplay/Hit"));
                        if (getBuffedValue(MapleBuffStat.POWERGUARD) != null || getBuffedValue(MapleBuffStat.WATER_SHIELD) != null) {
                            MapleStatEffect eff = this.getJob() >= 3110 ? this.getStatForBuff(MapleBuffStat.POWERGUARD) : this.getJob() >= 111 ? this.getStatForBuff(MapleBuffStat.POWERGUARD) : null;
    ...
    public Pair<Double, Boolean> modifyDamageTakenNoBoss(double damage, MapleMapObject attacke) {
        Pair<Double, Boolean> ret = new Pair<>(damage, false);
        if (damage <= 0) {
            return ret;
        }
        if (stats.ignoreDAMrSkill > 0 && damage != 1 && GameConstants.isDemonSlayer(getJob())) {
            damage -= Math.floor((stats.ignoreDAMrSkill * damage) / 100.0f);
            getClient().getSession().write(CField.EffectPacket.showOwnBuffEffect(31120009, 7, getLevel(), MapleStatEffect.level));
            getMap().broadcastMessage(this, CField.EffectPacket.showBuffeffect(getId(), 31120009, 7, getLevel(), MapleStatEffect.level), false);
        }
        if (stats.ignoreDAMrSkill > 0 && damage != 1 && GameConstants.isWindArcher(getJob())) {
            damage -= Math.floor((stats.ignoreDAMrSkill * damage) / 100.0f);
        }
        ret.left = damage;
        return ret;
    ...
    public void onAttack(long maxhp, int maxmp, int skillid, int oid, int totDamage, int critCount) {
        ...
        if (stats.hpRecoverSkillProp > 0) {
            if (Randomizer.nextInt(100) <= stats.hpRecoverSkillProp) {//i think its out of 100, anyway
                if (isSuperGM()) {
            }
                if (stats.hpRecoverSkillPercent > 0) {
                    healHP(stats.getCurrentMaxHp() * 5 / 100);
                }
            }
        }
        if (stats.mpRecoverProp > 0 && !GameConstants.isDemonSlayer(getJob())) {
            if (Randomizer.nextInt(100) <= stats.mpRecoverProp) {//i think its out of 100, anyway
                healMP(stats.mpRecover  * stats.getCurrentMaxMp(job)/ 100);
            }
        }
        ...
        if (skillid > 0) {
            ...
            switch (skillid) {
                ...
                case 5111004: { // Energy Drain
                    addHP(((int) Math.min(maxhp, Math.min(((int) ((double) totDamage * (double) effect.getX() / 100.0)), stats.getCurrentMaxHp()/ 2))));
                    int toadd = (((int) Math.min(maxhp, Math.min(((int) ((double) totDamage * (double) effect.getX() / 100.0)), stats.getCurrentMaxHp()/ 2))));
                    break;
                }
                case 5211006:
        ...
        if (getLuminousState() != 20040220 && getLuminousState() == 20040216 && GameConstants.isLightSkills(skillid)){//light
                    addHP(getStat().getCurrentMaxHp() * 1 / 100);
                    }
            else if (getLuminousState() != 20040220 && getLuminousState() == 20040217 && GameConstants.isDarkSkills(skillid)){//light
                     addHP(getStat().getCurrentMaxHp() * 1 / 100);
                    }
            else if (getLuminousState() == 20040220 && GameConstants.isDarkSkills(skillid) || getLuminousState() == 20040220 && GameConstants.isLightSkills(skillid)){//light
                     addHP(getStat().getCurrentMaxHp() * 1 / 100);
                    }
             }
   ...
   public void handleForceGain(int oid, int skillid) {
    ...
    public void handleForceGain(int oid, int skillid, int extraForce) {
        ...
        bof = getTotalSkillLevel(bx);
        eff = bx.getEffect(bof);
        if (getSkillLevel(31110009) > 0 && Randomizer.nextInt(100) <= eff.getProb()) {
        forceGain += 1;  
        }
        force++; // counter
    ...
    public void afterAttack(int mobCount, int attackCount, int skillid) {
        switch (getJob()) {
            ...
            case 2411:
            case 2412:
                if (skillid != 1101012 && skillid != 1111003 && skillid != 1111005 && skillid != 1111008 && skillid != 1111005 && skillid != 11111002 && skillid != 11111003 && getBuffedValue(MapleBuffStat.COMBO) != null) { // shout should not give orbs
                    handleOrbgain();
                }
                break;
        }
    ...
    public void setPetAutoFeed(boolean toggle){
        if(toggle)
            this.dropMessage(5, "Pet Autofeed has been enabled.");
        else
            this.dropMessage(5, "Pet Autofeed has been disabled.");
        petAutoFeed = toggle;
    }
    ...
    public void addHonourExp(int amount) {
        ...
        client.getSession().write(CField.updateHonour(getHonourLevel(), getHonourExp(), false));
    ...
    public void honourLevelUp() {
        ...
        client.getSession().write(CField.updateHonour(getHonourLevel(), 0, true));
        InnerSkillValueHolder inner = null;
        byte ability = 0;
        switch (getHonourLevel()) {
            case 2:
                inner = InnerAbillity.getInstance().renewSkill(0, -1, true);
                ability = 1;
                break;
            case 30:
                inner = InnerAbillity.getInstance().renewSkill(Randomizer.rand(0, 2), -1, true);
                ability = 2;
                break;
            case 70:
                inner = InnerAbillity.getInstance().renewSkill(Randomizer.rand(1, 3), -1, true);
                ability = 3;
                break;
        }
     ...
     public void ResetInnerPot() {
            ...
            int i = 0;
            for (InnerSkillValueHolder isvh : client.getPlayer().getInnerSkills()) {
                    if (i == 0 && client.getPlayer().getInnerSkills().size() > 1) { //Ultimate Circulator
                        newValues.add(InnerAbillity.getInstance().renewSkill(isvh.getRank(), 2702000, true, false));
                    } else {
                        newValues.add(InnerAbillity.getInstance().renewSkill(isvh.getRank(), 2702000, false, false));
                    }
                    //c.getPlayer().changeSkillLevel(SkillFactory.getSkill(isvh.getSkillId()), (byte) 0, (byte) 0);
                i++;
            }
            client.getPlayer().getInnerSkills().clear();
            byte ability = 1;
            for (InnerSkillValueHolder isvh : newValues) {
                client.getPlayer().getInnerSkills().add(isvh);
                client.getSession().write(CField.updateInnerPotential(ability, isvh.getSkillId(), isvh.getSkillLevel(), isvh.getRank()));
                ability++;
        ...
        client.getPlayer().dropMessage(5, "Inner Potential has been reconfigured.");
        stats.recalcLocalStats(this);
        client.getSession().write(CWvsContext.enableActions());
     }
   ...
   /* public int DeleteInners(int charid, boolean channelserver) {
        Connection con = DatabaseConnection.getConnection();
        final MapleCharacter ret = new MapleCharacter(channelserver);
        try {
            int ret_count = 0;
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                    ret.innerSkills.remove(new InnerSkillValueHolder(rs.getInt("skill_id"), rs.getByte("skill_level"), rs.getByte("max_level"), rs.getByte("rank")));
                }
            if (rs.next()) {
                ret_count = rs.getInt(1);
            } else {
...
//    }
    ...
    public void checkCustomReward(int level) {
        ...
        switch (level) {
            case 100:
                //save for mastery books
                //addReward(4, 0, 0, 50000000, 0, "Here is a special reward for the experts! Beta only tho.");//just for beta
                break;
            case 150:
                addReward(1,2049609, 0, 0, 0, "Did you know that this scroll can reset your equip stats? try it out!");
                mp = 10000;
                break;
            case 170:
                addReward(1,2049122, 0, 0, 0, "Did you know that this scroll can increase more stats than a regular chaos scroll? try it out!");
                mp = 20000;
                break;
            case 200:
                addReward(1,2049122, 0, 0, 0, "Congratulations on reaching level 200, keep training until 250!");
                mp = 50000;
                break;
        }
    ...
    public static void GiveLinkedSkill(LittleEndianAccessor slea, MapleClient c) throws SQLException {
        //LINKED SKILLS
        ...
        //[0F 00 00 00] //Character ID of the character receiving it.(15, CloudSky)
         ...
         switch(skillFrom){
			case 110:
				skillTo= 80000000;//Pirate Blessing
				break;
			case 20021110:
				skillTo= 80001040;//Elven Blessing
				break;
			case 20030204:
				skillTo= 80000002;//Phantom Instinct
				break;
			case 20040218:
				skillTo= 80000005;//Light Wash
				break;
			case 30010112:
				skillTo= 80000001;//Fury Unleashed
				break;
			case 50001214:
				skillTo= 80001140;//Knight's Watch
				break;
			case 60000222:
				skillTo= 80000006;//Iron Will
				break;
			case 60011219:
				skillTo= 80001155;//Terms and Conditions
				break;
                        case 110000800:
				skillTo= 80010006;//Focus Spirit
				break;
                        case 30010241:
				skillTo= 80000050;//Wild Rage
				break;
                        case 40010001:
				skillTo= 80000003;//Keen Edge
				break;
                        case 40020002:
				skillTo= 80000004;//Elementalism
				break;
                        case 30020233:
				skillTo= 80000047;//Hybrid Logic
				break;
		}
         
         if(skillTo == 0){ //trying to add invalid link skill
         ...
         for(Integer receivingChar : receivingCharacters){
             ...
             deleteSkillQuery.setInt(2, skillTo);
             ...
             addLinkSkills.setInt(2, skillTo);
    ...
    public void changeLuminousMode(final int skillid) {
        ...
        if (sunfire) {
            ...
            InterServerHandler.runningLight -= 1;
        } else if (eclipse) {
            chr.setLuminousState(20040217);
            InterServerHandler.runningDark -=1;
        }
        client.getSession().write(JobPacket.LuminousPacket.updateLuminousGauge(InterServerHandler.runningDarkSlot, InterServerHandler.runningLightSlot, InterServerHandler.runningDark, InterServerHandler.runningLight));
        int Level = chr.getTotalSkillLevel(27120008);
        SkillFactory.getSkill(20041239).getEffect(chr.getTotalSkillLevel(20041239)).applyBuffEffect(chr, chr, true, 10000 + ((Level * 1000) * getStat().BuffUP / 100) + (Level * 1000));
    }
    ...
    public void handleLuminous(int skillid) {
        ...
        boolean found = false;
        if (skillid != 27120211 && skillid != 27121201) {
        SkillFactory.getSkill(27110007).getEffect(getTotalSkillLevel(27110007)).applyBuffEffect(this, this, true, 2000000000);
        }
        for (int light : lightSkills) {
            if (skillid == light) {
                if (getLuminousState() <= 20040000 && getLevel() >= 30) {
                getClient().getSession().write(JobPacket.LuminousPacket.giveLuminousState(20040216, getLightGauge(), getLightGauge(), 2000000000));
                getClient().getSession().write(JobPacket.LuminousPacket.updateLuminousGauge(InterServerHandler.runningDarkSlot, InterServerHandler.runningLightSlot, InterServerHandler.runningDark, InterServerHandler.runningLight));
                setLuminousState(20040216);
                 }
                if (InterServerHandler.runningLight < 5) {
                InterServerHandler.runningLightSlot += Randomizer.nextInt(200) + 100;
                }
                if (InterServerHandler.runningLightSlot > 10000) {
                    InterServerHandler.runningLightSlot = 0;
                    InterServerHandler.runningLight += 1;
                    if (InterServerHandler.runningLight > 5) {
                        InterServerHandler.runningLight = 5;
                    }
                }
                 if (isSuperGM() && InterServerHandler.runningLightSlot > 1000) {
                    InterServerHandler.runningLightSlot = 0;
                    InterServerHandler.runningLight += 1;
                    if (InterServerHandler.runningLight > 5) {
                        InterServerHandler.runningLight = 5;
        ...
        for (int dark : darkSkills) {
            if (getLuminousState() <= 20040000 && getLevel() >= 30) {
                getClient().getSession().write(JobPacket.LuminousPacket.giveLuminousState(20040217, getLightGauge(), getDarkGauge(), 2000000000));
                getClient().getSession().write(JobPacket.LuminousPacket.updateLuminousGauge(InterServerHandler.runningDarkSlot, InterServerHandler.runningLightSlot, InterServerHandler.runningDark, InterServerHandler.runningLight));
                setLuminousState(20040217);
                 }
            if (skillid == dark) {
                if (InterServerHandler.runningDark < 5) {
                InterServerHandler.runningDarkSlot += Randomizer.nextInt(200) + 100;
                }
                if (InterServerHandler.runningDarkSlot > 10000) {
                    InterServerHandler.runningDarkSlot = 0;
                    InterServerHandler.runningDark += 1;
                    if (InterServerHandler.runningDark > 5) {
                        InterServerHandler.runningDark = 5;
                    }
                }
                if (isSuperGM() && InterServerHandler.runningDarkSlot > 1000) {
                    InterServerHandler.runningDarkSlot = 0;
                    InterServerHandler.runningDark += 1;
                    if (InterServerHandler.runningDark > 5) {
                        InterServerHandler.runningDark = 5;//Wings
                        InterServerHandler.runningDarkSlot = 0;//Cancel gain because it's full
                    }
                }
                found = true;
            }
    ...
    public void resetRunningStack() {
        this.runningStack = 0;
        InterServerHandler.runningDark = 0;
        InterServerHandler.runningDarkSlot = 0;
        InterServerHandler.runningLight = 0;
        InterServerHandler.runningLightSlot = 0;
    }
    ...
    public int getLightGauge() {
        return InterServerHandler.runningLightSlot;
    }

    public int getDarkGauge() {
        return InterServerHandler.runningDarkSlot;
    }
    ...
    public void applyBlackBlessingBuff(int combos) {
        ...
        int lvl = getTotalSkillLevel(27100003);
        if (lvl > 0) {
                skill.getEffect(lvl).applyBlackBlessingBuff(this, combos);
            }
        }
    ...
    public short getExceed() {
     ...
     public short getCrescendo() {
        return crescendo;
    }
     
    public void setCrescendo(short amount) {
        this.exceed = amount;
    }
    ...
    public void gainCrescendo(short amount) {
        this.crescendo += amount;
        updateCrescendo(crescendo);
    }
    
    public void updateCrescendo(short amount) {
        client.getSession().write(LuminousPacket.giveCrescendo(amount));
    }
