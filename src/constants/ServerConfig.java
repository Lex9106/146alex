...
public class ServerConfig {
    ...
    public static final String serverName = "Crimsonstory";
    public static final String eventMessage = "v145 Crimsonstory Development!";
    ...
    public static final int channelCount = 4;
    public static final String events = "" + "AutomatedEvent," + "EvolutionLab,CygnusBattle,ScarTarBattle,BossBalrog_EASY,BossBalrog_NORMAL,HorntailBattle,ChaosHorntailBattle,Nibergen,PinkBeanBattle,ZakumBattle,NamelessMagicMonster,Dunas,Dunas2,2095_tokyo,ZakumPQ,LudiPQ,KerningPQ,ProtectTylus,WitchTower_EASY,WitchTower_Med,WitchTower_Hard,Vergamot,ChaosHorntail,ChaosZakum,CoreBlaze,BossQuestEASY,BossQuestMed,BossQuestHARD,BossQuestHELL,BossQuestCHAOS,Ravana_EASY,Ravana_HARD,Ravana_MED,Aufhaven,Dragonica,Rex,MonsterPark,KentaPQ,ArkariumBattle,HillaBattle,The Dragon Shout,VonLeonBattle,Ghost,OrbisPQ,GolluxPQ,Romeo,Juliet,Pirate,Amoria,Ellin,CWKPQ,DollHouse,Kenta,Prison,HenesysPQ,jett2ndjob,Rex,Trains,Boats,Flight,Visitor,AirPlane,Ghost,PinkBeanBattle,Subway,PierreBattle,PierreEasy,QueenBattle,QueenEasy,VellumBattle,VellumEasy,VonBonBattle,VonBonEasy,EasyMagnus,MagnusBattle";
    ...
    public static final int EXP = 1; //exp rate (only works when fixedRates = true)
    public static final int MESO = 10; //meso rate (only works when fixedRates = true)
