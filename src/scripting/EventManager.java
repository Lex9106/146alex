...
public class EventManager {
    ...
    public void cancel() {
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : cancelSchedule:\n" + ex);
        }
    }
        ...
        return EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : " + methodName + ":\n" + ex);
                }
            }
        }, delay);
    }
    ...
    public void startInstance() {
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : setup:\n" + ex);
        }
    }
    ...
    public void startInstance(MapleCharacter character, String leader) {
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : setup-Guild:\n" + ex);
        }
    }
    ...
    public void startInstance_CharID(MapleCharacter character) {
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : setup-CharID:\n" + ex);
        }
    }
    ...
    public void startInstance(MapleCharacter character) {
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : setup-character:\n" + ex);
        }
    }

    //PQ method: starts a PQ
    public void startInstance(MapleCharacter chr, MapleParty party, MapleMap map, int questID) {
        startInstance(chr, party, map, 255, questID);
        System.out.println("hi there (:");
    }

    public void startInstance(MapleCharacter chr, MapleParty party, MapleMap map, int maxLevel, int questID) {
        try {
            ...
            for (MaplePartyCharacter mpc : party.getMembers()) {
                ...
                if (questID > 0) {
                    chr.getQuestNAdd(MapleQuest.getInstance(questID)).setCustomData(String.valueOf(System.currentTimeMillis()));
                }
            }
            if (size <= 0) {
                return;
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : setup-partyid:\n" + ex);
        } catch (Exception ex) {
            //ignore
    ...
    public void startInstance_NoID(MapleParty party, MapleMap map, final Exception old) {
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : setup-party:\n" + ex + "\n" + (old == null ? "no old exception" : old));
        }
    }
    ...
    public void startInstance(EventInstanceManager eim, String leader) {
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : setup-leader:\n" + ex);
        }
    }
    ...
    public void startInstance(MapleSquad squad, MapleMap map, int questID) {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name : " + name + ", method Name : setup-squad:\n" + ex);
        }
    }
