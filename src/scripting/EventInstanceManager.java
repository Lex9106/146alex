...
public class EventInstanceManager {
    ...
    public void registerPlayer(MapleCharacter chr) {
        ...
        try {
            ...
            ////FileoutputUtiloutputFileError(//FileoutputUtilScriptEx_Log, ex);
        } catch (NoSuchMethodException | ScriptException ex) {
           // //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : playerEntry:\n" + ex);
    ...
    public void changedMap(final MapleCharacter chr, final int mapid) {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : changedMap:\n" + ex);
        ...
        eventTimer = EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : scheduledTimeout:\n" + ex);
    ...
    public void spawnMonster(MapleCharacter chr,int id) {
        spawnMonster(chr,id, 1, chr.getTruePosition());
    }

    // summon one monster, remote location
    public void spawnMonster(MapleCharacter chr,int id, int x, int y) {
        spawnMonster(chr,id, 1, new Point(x, y));
    }

    // multiple monsters, remote location
    public void spawnMonster(MapleCharacter chr,int id, int qty, int x, int y) {
        spawnMonster(chr,id, qty, new Point(x, y));
    }

    // handler for all spawnMonster
    public void spawnMonster(MapleCharacter chr,int id, int qty, Point pos) {
        for (int i = 0; i < qty; i++) {
            chr.getMap().spawnMonsterOnGroundBelow(MapleLifeFactory.getMonster(id), pos);
        }
    }
    ...
    public final void RemoveBuff(final MapleCharacter chr, final int id) {
       chr.dispelBuff(id);
    }
    ...
    public void unregisterMonster(MapleMonster mob) {
        ...
        if (mobs.isEmpty()) {
            try {
                ...
                //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : allMonstersDead:\n" + ex);
    ...
    public void playerKilled(MapleCharacter chr) {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : playerDead:\n" + ex);
    ...
    public boolean revivePlayer(MapleCharacter chr) {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : playerRevive:\n" + ex);
    ...
    public void playerDisconnected2(final MapleCharacter chr, int idz) {
        System.out.println("Player Disconected.");
        if (disposed) {
            return;
        }
    ...
    public void monsterKilled(final MapleCharacter chr, final MapleMonster mob) {
        ...
        try {
            int inc = ((Double) em.getIv().invokeFunction("monsterValue", this, mob.getId(), chr)).intValue();
            if (disposed || chr == null) {
                return;
            }
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + (em == null ? "null" : em.getName()) + ", Instance name : " + name + ", method Name : monsterValue:\n" + ex);
    ...
    public void dispose_NoLock() {
        ...
        try {
            ...
            //FileoutputUtiloutputFileError(//FileoutputUtilScriptEx_Log, e);
        }
    }
        ...
        EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name(schedule) : " + methodName + " :\n" + ex);
                }
            }
        }, delay);
    }
    ...
    public final void leftParty(final MapleCharacter chr) {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : leftParty:\n" + ex);
        }
    }
    ...
    public final void disbandParty() {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : disbandParty:\n" + ex);
        }
    }
    ...
    public final void finishPQ() {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : clearPQ:\n" + ex);
        }
    }

    public final void removePlayer(final MapleCharacter chr) {
        if (chr.isSuperGM()) {
        chr.dropMessage(5, "Exit from the Event");    
        }
        if (disposed) {
            return;
        }
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : playerExit:\n" + ex);
        }
    }
    ...
    public final void registerCarnivalParty(final MapleCharacter leader, final MapleMap map, final byte team) {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : registerCarnivalParty:\n" + ex);
        } catch (NoSuchMethodException ex) {
            //ignore
        }
    }
    ...
    public void onMapLoad(final MapleCharacter chr) {
        ...
        try {
            ...
            //FileoutputUtillog(//FileoutputUtilScriptEx_Log, "Event name" + em.getName() + ", Instance name : " + name + ", method Name : onMapLoad:\n" + ex);
        } catch (NoSuchMethodException ex) {
