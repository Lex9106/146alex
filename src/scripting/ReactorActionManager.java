...
public class ReactorActionManager extends AbstractPlayerInteraction {
        ...
        for (final ReactorDropEntry d : items) {
            if (d.itemId == 0) {
                ...
                if (GameConstants.getInventoryType(d.itemId) != MapleInventoryType.EQUIP) {
                    ...
                    drop = ii.randomizeStats((Equip) ii.getEquipById(d.itemId), null, null);
                }
    ...
    public void dropSingleItem(int itemId) {
        ...
        if (GameConstants.getInventoryType(itemId) != MapleInventoryType.EQUIP) {
            ...
            drop = MapleItemInformationProvider.getInstance().randomizeStats((Equip) MapleItemInformationProvider.getInstance().getEquipById(itemId), null, null);
        }
        drop.setGMLog("Dropped from reactor " + reactor.getReactorId() + " on map " + getPlayer().getMapId());
