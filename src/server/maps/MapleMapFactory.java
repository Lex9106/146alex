...
//        customNPC.add(new Pair<>(910000000, loadLife(1033225, 0, true, 42, -266, 638, 638, 638, -266, "n", 0)));//Shadow Knight cuz not coded..
                                                                    //  FH    CY      RX0   RX1   X   Y    TYPE   MOBTIME
       // customNPC.add(new Pair<>(970000000, loadLife(2003, 0, false,    195, -266,    537, 437, 487, 18, "n", 0)));//Custom
       // customNPC.add(new Pair<>(970000000, loadLife(9010034, 0, false, -20, 4,       1412,  1312, 1362, 34, "n", 0)));//Cygnus and fiends
       // customNPC.add(new Pair<>(970000000, loadLife(9010035, 0, false, 22, 4,       1442, 1342, 1392, 34, "n", 0)));
       // customNPC.add(new Pair<>(970000000, loadLife(9010036, 0, false, 22, 4,       1382,  1282, 1312, 34, "n", 0)));
       // customNPC.add(new Pair<>(970000000, loadLife(9071006, 0, false, 0, -266,    -45, -145, -95, -2, "n", 0)));//Spiegelette
       // customNPC.add(new Pair<>(970000000, loadLife(9201102, 0, false, 93, 4,       620,  575, 625, -399, "n", 0)));//Stirgeman
