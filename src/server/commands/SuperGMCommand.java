...
public static EnumMap<MapleBuffStat, Integer> statups;
    ...
    public static class ApplyBuff extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
            int type = Integer.parseInt(splitted[1]);
            SkillFactory.getSkill(type).getEffect(1).applyTo(c.getPlayer());
            return 1;
        }
    }
    
    public static class gainExp extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
        long gain = Integer.parseInt(splitted[1]);
        c.getPlayer().gainExp((long) gain, true, true, true);
         return 1;
        }
    }
    
    public static class setskill extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
        PlayerHandler.skillidgm = Integer.parseInt(splitted[1]);
         return 1;
        }
    }
    
    public static class setnumber extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
        PlayerHandler.number = Integer.parseInt(splitted[1]);
         return 1;
        }
    }
    ...
    public static class ServerNotice extends CommandExecute {
     ...
     public static class gmnpc extends CommandExecute {
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            NPCScriptManager.getInstance().start(c, 9201257, null);
            return 1;
        }
    }
     
     public static class nocd extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (!ii.itemExists(itemId)) {
                ...
                if (GameConstants.getInventoryType(itemId) == MapleInventoryType.EQUIP) {
                    ...
                    toDrop = ii.randomizeStats((Equip) ii.getEquipById(itemId), c.getPlayer(), c.getPlayer().getClient());
                } else {
  ...
  /*  public static class Vac extends CommandExecute {
    ...
    public static class Buffs extends CommandExecute {

        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, "Buff Stat Applied :" + statups);
            return 1;
        }
    }    
    public static class ReloadOps extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(5, "Ops Reloaded.");
            return 1;
        }
    }
    ...
    public static class sh extends CommandExecute {
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().setHair(Integer.parseInt(splitted[1]));
            c.getPlayer().updateSingleStat(MapleStat.HAIR, c.getPlayer().getHair());
            c.getPlayer().equipChanged();
            c.getPlayer().dropMessage(5, "Id of hair is " + c.getPlayer().getHair());
            return 1;
        }
    }
    
    public static class sf extends CommandExecute {

        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().setFace(Integer.parseInt(splitted[1]));
            c.getPlayer().updateSingleStat(MapleStat.FACE, c.getPlayer().getFace());
            c.getPlayer().equipChanged();
            c.getPlayer().dropMessage(5, "Id of Face is " + c.getPlayer().getFace());
            return 1;
        }
    }
