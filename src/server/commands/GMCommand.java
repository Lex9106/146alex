...
public class GMCommand {
    ...
    public static class RFly extends CommandExecute {

        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dispelBuff(1146);
            c.getPlayer().dispelBuff(1142);
            return 1;
        }
    }
    ...
    public static class PotentialItem extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (itemId >= 2000000) {
                ...
                Equip equip;
                equip = ii.randomizeStats((Equip) ii.getEquipById(itemId), c.getPlayer(), c.getPlayer().getClient());
