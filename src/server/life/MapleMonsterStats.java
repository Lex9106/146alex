...
public class MapleMonsterStats {
    ...
    private long hp, finalmaxhp, healThreshold;
    ...
    private boolean eliteMob, boss, undead, ffaLoot, firstAttack, isExplosiveReward, mobile, fly, onlyNormalAttack, friendly, noDoom, invincible, partyBonusMob, changeableMob, escort;
    ...
    public void setElite(boolean eliteMob) {
