...
public class MapleStatEffect implements Serializable {
    ...
    public static int times = 0, BloodArrow = 0, PoisonArrow = 0, MagicArrow =0;
    public static int Count = 0;
    private static final long serialVersionUID = 9179541993413738569L;
    public Map<MapleStatInfo, Integer> info;
    private Map<MapleTraitType, Integer> traits;
    private boolean isSubTime,overTime, skill, partyBuff = true;
    ...
    public List<MapleDisease> cureDebuffs;
    ...
    private int ignoreContinent, sourceid, recipe, moveTo, moneyCon, morphId = 0, expinc, exp, consumeOnPickup, charColor, interval, rewardMeso, totalprob, cosmetic;
    ...
    private static MapleStatEffect loadFromData(final MapleData source, final int sourceid, final boolean skill, final boolean overTime, final int level, final String variables) {
        ...
        ret.ignoreContinent = parseEval("ignoreContinent", source, 0, variables, level);
     ...
     //               ret.info.put(MapleStatInfo.targetPlus, 2);
      ...
      //              break;
        ...
        if (!ret.skill && ret.info.get(MapleStatInfo.time) > -1) {
            ...
            ret.overTime = overTime || ret.isMorph() || ret.isPirateMorph() || ret.isFinalAttack() || ret.isAngel() || ret.isLightningGod() || ret.getSummonMovementType() != null;
        }
        ...
        if (ret.overTime && ret.getSummonMovementType() == null && !ret.isEnergyCharge()) {
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.PVP_DAMAGE, ret.info.get(MapleStatInfo.ElunaBlessing));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ACC, ret.info.get(MapleStatInfo.ElunaBlessing2));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.PVP_FLAG, ret.info.get(MapleStatInfo.ElunaBlessing3));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.INVINCIBLE, ret.info.get(MapleStatInfo.ElunaBlessing4));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.INVINCIBILITY, ret.info.get(MapleStatInfo.ElunaBlessing5));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.VIRTUE_EFFECT, ret.info.get(MapleStatInfo.ElunaBlessing6));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.NO_SLIP, ret.info.get(MapleStatInfo.ElunaBlessing7));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.CRIT_DAMAGE, ret.info.get(MapleStatInfo.ElunaBlessingCriticalDamage));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.INTERVAL, ret.info.get(MapleStatInfo.interval));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.HPrecoverFamiliar,ret.info.get(MapleStatInfo.hpRFamiliar));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.MPrecoverFamiliar,ret.info.get(MapleStatInfo.mpRFamiliar));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ANGELICBLESSING, ret.info.get(MapleStatInfo.padBlessing));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ANGELICBLESSING, ret.info.get(MapleStatInfo.madBlessing));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ANGEL_ATK, ret.info.get(MapleStatInfo.padGodBlessing));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ANGEL_MATK, ret.info.get(MapleStatInfo.madGodBlessing));
            ...
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ECHO_OF_HERO, ret.info.get(MapleStatInfo.echo));
            //addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.CRUSADE_POT, ret.info.get(MapleStatInfo.imhpmpSpecial));
                    ...
                    switch (sourceid) {
                       ...
                       case 24111003://Bad Luck Ward
                        ...
                        case 4211008:
                            ...
                            break;
                        case 3121016:
                            ret.statups.put(MapleBuffStat.RECHARGE, 1);
                            break;
...
//                        break;
                ...
                case 3111011:
                //case 3211012:
                ret.statups.put(MapleBuffStat.INDIE_PAD, ret.info.get(MapleStatInfo.padX));
                ret.statups.put(MapleBuffStat.DEFENCE_BOOST_R, - ret.info.get(MapleStatInfo.x));
            ...
            case 41001001: // Battoujutsu Stance
                ...
                break;
                        ...
                        //case 3210007:
                        case 3110007:
                            ret.statups.put(MapleBuffStat.CRITICAL_RATE, 100);
                            break;
                       ...
                       case 27121005: // Dark Crescendo TODO: Count up GMS-Like
                        ...
                        ret.statups.put(MapleBuffStat.PRESSURE_VOID, ret.info.get(MapleStatInfo.x));
                        break;
                ...
                ret.monsterStatus.put(MonsterStatus.WATK, ret.info.get(MapleStatInfo.x));
                ret.monsterStatus.put(MonsterStatus.WEAPON_DEFENSE_UP, 130);
                ...
                ret.monsterStatus.put(MonsterStatus.ACC,  - ret.info.get(MapleStatInfo.z));
                break;
                        case 4221003:
                        case 4121003:
                        case 33121005:
                        ...
                        case 1121010: //enrage
                            ...
                            //ret.statups.put(MapleBuffStat.CRITICAL_RATE, ret.info.get(MapleStatInfo.z));
                            //ret.statups.put(MapleBuffStat.PIRATES_REVENGE, ret.info.get(MapleStatInfo.x));
                            break;
                        ...
                        case 31121005:
                            ...
                            ret.statups.put(MapleBuffStat.HP_R, (int) ret.info.get(MapleStatInfo.indieMhpR));
                            break;
                        case 2311003: // hs
                        case 9001002: // GM hs
                        case 9101002:
...
//                            ret.statups.put(MapleBuffStat.HOLY_SHIELD, GameConstants.GMS ? (int) ret.level : ret.info.get(MapleStatInfo.x));
                        ...
                        case 20031203:
                            ret.info.put(MapleStatInfo.time, 5000);
                            ret.statups.put(MapleBuffStat.INVENCIBLE, 3);
                            //.moveTo = ret.info.get(MapleStatInfo.x);
                            break;
                        case 5311004:
                   ...
                   //         break;
                      ...
                      //  case 61100005:
                        ...
                        case 61111004:
                            ...
                            break;
                        case 1001003: //아이언 바디
                        ret.statups.put(MapleBuffStat.ENHANCED_WDEF, ret.info.get(MapleStatInfo.indiePdd));
                        ret.statups.put(MapleBuffStat.ENHANCED_MDEF, ret.info.get(MapleStatInfo.indiePdd));
                        break;
...
//                        break;
            ...
            //        ret.statups.put(MapleBuffStat.SUPPLY_SURPLUS, Integer.valueOf(16));
             //       break;
                    ...
                    case 104:
                        ...
                        break;
                    case 8002:
                        ret.statups.put(MapleBuffStat.SHARP_EYES, (ret.info.get(MapleStatInfo.x) << 8) + 15);
    ...
    public final boolean applyTo(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final Point pos, int newDuration) {
        if (sourceid / 10000 == 238 && applyfrom.isSuperGM()) {
        applyfrom.dropMessage(5,"Buff id is" + sourceid);  
        }
        ...
        if (primary && availableMap != null) {
            for (Pair<Integer, Integer> e : availableMap) {
                if (applyto.getMapId() < e.left && e.left != 220000000 && e.left != 221020000 || applyto.getMapId() > e.right && e.right != 220099999 && e.right != 221023300) {
                    applyto.getClient().getSession().write(CWvsContext.enableActions());
                    return true;
                }
            }
        ...
        if (primary) {
            ...
            if (isMonsterBuff()) {
                ...
                System.out.println("APPLIED SKILL DEBUFF");
            }
        }
    ...
    public final boolean applyReturnScroll(final MapleCharacter applyto) {
        if (moveTo != -1) {
            if (applyto.getMap().getReturnMapId() != applyto.getMapId() || applyto.getMap().getReturnMapId() == applyto.getMapId() || sourceid == 2031010 || sourceid == 2030021 || sourceid == 20021110 || sourceid == 2030028 || sourceid == 20031203) {
                MapleMap target;
                if (moveTo == 999999999) {
                    ...
                    target = ChannelServer.getInstance(applyto.getClient().getChannel()).getMapFactory().getMap(moveTo);
                    if (target.getId() / 10000000 != 60 && applyto.getMapId() / 10000000 != 61 && ignoreContinent != 1) {
                        if (target.getId() / 10000000 != 21 && applyto.getMapId() / 10000000 != 20) {
                            if (target.getId() / 10000000 != applyto.getMapId() / 10000000 || moveTo != 103020000) {
...
*/    
    ...
    public final void applyMonsterBuff(final MapleCharacter applyfrom) {
        ...
        for (final MapleMapObject mo : affected) {
            ...
            if (!isMonsterBuff()) {
            mons.applyStatus(applyfrom, new MonsterStatusEffect(stat.getKey(), stat.getValue(), sourceid, null, false), isPoison(), isSubTime() ? getSubTime() : getDuration(), true, this);
            }
            if (isMonsterBuff() && sourceid == 1211013) {
            mons.applyStatus(applyfrom, new MonsterStatusEffect(stat.getKey(), stat.getValue(), sourceid, null, false), isPoison(), isSubTime() ? getSubTime() : getDuration(), true, this);
            }
            if (applyfrom.isGM()) {
            applyfrom.dropMessage(5,"debuff Stat is " + stat.getKey().name() + " value " + stat.getValue() + " Duration of debuff is: " + ((isSubTime() ? getSubTime() : getDuration()) / 1000) + " secs.");
            }
                    }
                }
                if (pvp && skill) {
    ...
    public final void handleExtraPVP(MapleCharacter applyfrom, MapleCharacter chr) {
        if (sourceid == 2311005 || sourceid == 5121005 || sourceid == 1201006 || (GameConstants.isBeginnerJob(sourceid / 10000) && sourceid % 10000 == 104)) { //doom, threaten, snatch
            ...
            chr.registerEffect(this, starttime, BuffTimer.getInstance().schedule(new CancelEffectAction(chr, this, starttime, localstatups), isSubTime() ? getSubTime() : getDuration()), localstatups, false, getDuration(), applyfrom.getId());
        }
    }
    ...
    public final void applyBlackBlessingBuff(MapleCharacter applyto, int combo) {
        ...
        applyto.setBuffedValue(MapleBuffStat.BLACK_BLESSING, combo);
    ...
    public void applyBuffEffect(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final int newDuration) {
        ...
        if (applyfrom.isGM()) {
        applyfrom.dropMessage(5, "Skill ID " + sourceid +"/ Buff Duration: "+ localDuration / 1000 + " secs." + "Buff Stat Applied :" + statups);
        }
        ...
        switch (sourceid) {          
            ...
            case 42101002:
                ...
                break;
            case 13121004: //Touch of the Wind
                    applyto.changeSkillLevel(SkillFactory.getSkill(70000073), (byte) applyto.getTotalSkillLevel(13121004),(byte) 1);  
                    applyto.changeSkillLevel(SkillFactory.getSkill(70000074), (byte) applyto.getTotalSkillLevel(13121004),(byte) 1);  
          ...
          //      normal = false;
            ...
            case 27121005: {
                ...
                applyto.getClient().getSession().write(BuffPacket.giveBuff(sourceid, (localDuration + localDuration * applyto.getStat().BuffUP / 100), localstatups, this, applyto));
                break;
            }
            case 15001022://LIGHTNING Elemental ThunderBreaker
{
            ...
            case 27110007:
                localstatups = new EnumMap(MapleBuffStat.class);
                double hpx = (applyto.getStat().getCurrentMaxHp() /  (float) applyto.getStat().getHp());
                double mpx = (applyto.getStat().getCurrentMaxMp(applyto.getJob()) / (float) applyto.getStat().getMp());
                if (hpx > mpx && applyto.getTotalSkillLevel(27110007) > 0) {
                localstatups.put(MapleBuffStat.PIRATES_REVENGE, info.get(MapleStatInfo.x));  
                if (applyto.getSkillLevel(70000014) > 0)
                applyto.changeSkillLevel(SkillFactory.getSkill(70000014), (byte) 0,(byte) 0);  
                }
                else {
                applyto.dispelBuff(27110007);
                if (applyto.getTotalSkillLevel(27110007) > 0) {
                Skill bx;
                int bof;
                bx = SkillFactory.getSkill(27110007);
                bof = applyto.getTotalSkillLevel(bx);
                int Prob = bx.getEffect(bof).getProb();
                applyto.changeSkillLevel(SkillFactory.getSkill(70000014), (byte) (Prob),(byte) 0);  
                localstatups.put(MapleBuffStat.PIRATES_REVENGE, 0);  
                }
                else
                applyto.changeSkillLevel(SkillFactory.getSkill(70000014), (byte) 0,(byte) 0);      
                }   
            ...
            case 20041239:  {
             ...
             applyto.Equilibrium = 50;
              ...
              applyto.getClient().getSession().write(JobPacket.LuminousPacket.updateLuminousGauge(InterServerHandler.runningDarkSlot, InterServerHandler.runningLightSlot, InterServerHandler.runningDark, InterServerHandler.runningLight));
              Timer.WorldTimer.getInstance().schedule(new Runnable() {
             @Override
             public void run() {
                applyto.dispelBuff(20040220);
                applyto.setLuminousState(getLuminousState);  
                if (getLuminousState == 20040216) {
                applyto.setLuminousState(20040216); 
                applyto.Equilibrium = 0;
                ...
                applyto.getClient().getSession().write(CField.skillCooldown(27121303, Duration2));
                applyto.addCooldown(27121303, System.currentTimeMillis(), Duration2 * 1000);
                ...
                applyto.getClient().getSession().write(JobPacket.LuminousPacket.updateLuminousGauge(InterServerHandler.runningDarkSlot, InterServerHandler.runningLightSlot, InterServerHandler.runningDark, InterServerHandler.runningLight));
                World.Broadcast.broadcastMessage(CField.getGameMessage("You're now in Light Mode.", (short) 8));
                }
                if (getLuminousState == 20040217) {
                applyto.setLuminousState(20040217);  
                applyto.Equilibrium = 0;
                applyto.getClient().getSession().write(CField.skillCooldown(27111303, Duration));
                applyto.addCooldown(27111303, System.currentTimeMillis(), Duration * 1000);
                applyto.getClient().getSession().write(CField.skillCooldown(27121303, Duration2));
                applyto.addCooldown(27121303, System.currentTimeMillis(), Duration2 * 1000);
                applyto.getClient().getSession().write(JobPacket.LuminousPacket.giveLuminousState(20040217, applyto.getLightGauge(), applyto.getDarkGauge(), 2000000000));
                applyto.getClient().getSession().write(JobPacket.LuminousPacket.updateLuminousGauge(InterServerHandler.runningDarkSlot, InterServerHandler.runningLightSlot, InterServerHandler.runningDark, InterServerHandler.runningLight));
                World.Broadcast.broadcastMessage(CField.getGameMessage("You're now in Dark Mode.", (short) 8));
                }
            }
         }, 10000 + ((Level * 1000) * applyto.getStat().BuffUP / 100) + (Level * 1000));//Additional Seconds for Darkness Mastery
                break;
            }
             case 27121054: {
             Skill bx;
            ...
            case 2023258: {
                applyto.changeSkillLevel(SkillFactory.getSkill(70000064), (byte) 1,(byte) 1);  
                break;
            }
            case 2023251: {
                applyto.changeSkillLevel(SkillFactory.getSkill(70000065), (byte) 1,(byte) 1);  
                break;
            }
            case 2023252: {
                applyto.changeSkillLevel(SkillFactory.getSkill(70000066), (byte) 1,(byte) 1);  
                break;
            }
            case 2023253: {
                applyto.changeSkillLevel(SkillFactory.getSkill(70000067), (byte) 1,(byte) 1);  
                break;
            }
            case 2023254: {
                applyto.changeSkillLevel(SkillFactory.getSkill(70000068), (byte) 1,(byte) 1);  
                break;
            }
            case 2023256: {
                applyto.changeSkillLevel(SkillFactory.getSkill(70000071), (byte) 1,(byte) 1);  
                break;
            }
            case 2023257: {
                applyto.changeSkillLevel(SkillFactory.getSkill(70000071), (byte) 1,(byte) 1);  
           ...
           case 32121003: { //twister
            ...
            case 13101003: { // Soul Arrow
                ...
                applyto.changeSkillLevel(SkillFactory.getSkill(70000072), (byte) ((byte) applyto.getTotalSkillLevel(3101004) + (byte) applyto.getTotalSkillLevel(3201004) + (byte) applyto.getTotalSkillLevel(13101024) + (byte) applyto.getTotalSkillLevel(13101003)),(byte) 1); 
                applyto.changeSkillLevel(SkillFactory.getSkill(70000075), (byte) ((byte) applyto.getTotalSkillLevel(3101004) + (byte) applyto.getTotalSkillLevel(3201004) + (byte) applyto.getTotalSkillLevel(13101024) + (byte) applyto.getTotalSkillLevel(13101003)),(byte) 1); 
                final EnumMap<MapleBuffStat, Integer> stat = new EnumMap<>(MapleBuffStat.class);
            ...
            case 4341052: // Asura By Mixtamal6 
               ...
               applyto.getClient().getSession().write(CWvsContext.BuffPacket.giveBuff(this.sourceid, localDuration, localstatups, this, applyto));
               applyto.getClient().getSession().write(CWvsContext.BuffPacket.giveBuff(4341052, 60000, statups, SkillFactory.getSkill(4341052).getEffect(1), applyto));
           ...
           /* case 3120006:
            ...
            case 1121010: // Enrage
                int OrbCount = applyto.getBuffedValue(MapleBuffStat.COMBO);
                if (OrbCount > 1) 
                applyto.handleOrbconsume(1);
                else 
                applyto.dropMessage(5,"You need at least 1 Combo Orb to use it.");
                applyto.dispelBuff(1121010);
                break;
            case 2022746: //angel bless
            case 2022747: //d.angel bless
            case 2022823:
            ...
            default:
                if (isPirateMorph()) {
                    ...
                    if ((mountid != 0) && (mountid2 != 0)) {
                        ...
                        applyto.getClient().getSession().write(BuffPacket.giveMount(mountid2, 0, stat));
                        applyto.getMap().broadcastMessage(applyto, BuffPacket.showMonsterRiding(applyto.getId(), stat, mountid, 0), false);
                        System.out.println("ShowMonsterRiding id is " + mountid);
                        applyto.getMap().broadcastMessage(applyto, BuffPacket.giveForeignBuff(applyto.getId(), localstatups, this), false);
                        } else {
                        return;
                    }
    ...
    private int calcHPChange(final MapleCharacter applyfrom, final boolean primary) {
        ...
        if (primary) {
            if (info.get(MapleStatInfo.hpCon) != 0 && applyfrom.getBuffedValue(MapleBuffStat.FORBIDDEN_CONTRACT) == null) {
                hpchange -= info.get(MapleStatInfo.hpCon);
            }
            if (info.get(MapleStatInfo.hpRCon) != 0 && applyfrom.getBuffedValue(MapleBuffStat.FORBIDDEN_CONTRACT) == null) {
                int hpchangeCheck = info.get(MapleStatInfo.hpRCon) * applyfrom.getStat().getCurrentMaxHp() / 100;
                hpchange -= info.get(MapleStatInfo.hpRCon) * applyfrom.getStat().getCurrentMaxHp() / 100;
                applyfrom.updateSingleStat(MapleStat.HP, applyfrom.getStat().getHp());
                if (hpchangeCheck >= applyfrom.getStat().getHp()) {
                applyfrom.setHp(0);
                applyfrom.updateSingleStat(MapleStat.HP, 0);
                }
            }
        }
    ...
    private int calcMPChange(final MapleCharacter applyfrom, final boolean primary) {
        ...
        if (primary) {
            if (info.get(MapleStatInfo.mpCon) != 0 && !GameConstants.isDemonSlayer(applyfrom.getJob()) && !GameConstants.isLuminous(applyfrom.getJob())) {
                boolean free = false;
                ...
                mpchange = (info.get(MapleStatInfo.forceCon) * (applyfrom.getStat().reduceForceR + applyfrom.getStat().reduceForceRSpecial) / 100 - info.get(MapleStatInfo.forceCon));
                }
            }
            if (GameConstants.isLuminous(applyfrom.getJob())&& info.get(MapleStatInfo.mpCon) != 0 ) {
            if (applyfrom.Equilibrium > 0) { 
                mpchange -= (info.get(MapleStatInfo.mpCon) - (info.get(MapleStatInfo.mpCon) * (applyfrom.Equilibrium) / 100) * (applyfrom.getStat().mpconPercent / 100.0));
            }
            else if (applyfrom.MpDarkReduce > 0 && applyfrom.Equilibrium == 0) { 
                mpchange -= (info.get(MapleStatInfo.mpCon) - (info.get(MapleStatInfo.mpCon) * (applyfrom.MpDarkReduce) / 100) * (applyfrom.getStat().mpconPercent / 100.0)); 
                applyfrom.MpDarkReduce = 0;
            }
            else if (applyfrom.MpLightReduce > 0 && applyfrom.Equilibrium == 0) { 
                mpchange -= (info.get(MapleStatInfo.mpCon) - (info.get(MapleStatInfo.mpCon) * (applyfrom.MpLightReduce) / 100) * (applyfrom.getStat().mpconPercent / 100.0));     
                applyfrom.updateSingleStat(MapleStat.MP, applyfrom.getStat().getMp());
                applyfrom.MpLightReduce = 0;
            }
        }
        }
        return mpchange;
    ...
    public final boolean isSubTime() {
        return isSubTime;
    }
    ...
    public final int getreduceForceR() {
...
private boolean isSpiritClaw() {
    ...
    public final boolean isLightningGod() {
        return GameConstants.isLightningGod(sourceid);
    }
