    ...
    public void handleBuff(MapleStatEffect eff, int skill) {
        switch (skill) {
           ...
           case 31211003: // Ward Evil
                ...
                eff.statups.put(MapleBuffStat.ABNORMAL_STATUS_R, eff.info.get(MapleStatInfo.z));
                break;
          /* case 31211004: // Diabolic Recovery
           ...
           case 31221004:
                    ...
                    eff.statups.put(MapleBuffStat.ATTACK_SPEED, +1);
          //          eff.statups.put(MapleBuffStat.BOOSTER, 2);
           ...
           case 31121054:
                ...
                break;
           case 31221054:
               eff.statups.put(MapleBuffStat.FORBIDDEN_CONTRACT, 1);
               eff.statups.put(MapleBuffStat.HP_R, eff.info.get(MapleStatInfo.indieMhpR));
            default:
