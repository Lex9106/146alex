    ...
    public void handleBuff(MapleStatEffect eff, int skill) {
        switch (skill) {
            ...
            case 13101024:// Sylvan Aid
                ...
                //eff.statups.put(MapleBuffStat.ENHANCED_WATK, eff.info.get(MapleStatInfo.indiePad));
            ...
            case 13121054:// Storm Bringer
                eff.statups.put(MapleBuffStat.STORM_BRINGER, eff.info.get(MapleStatInfo.prop));
                break;
            default:
