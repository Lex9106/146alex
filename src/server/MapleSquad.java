...
public class MapleSquad {
    ...
    public static enum MapleSquadType {
        ...
        bossbalrog(1), zak(1), chaoszak(1), horntail(1), chaosht(1), pinkbean(1), nmm_squad(1), vergamot(1), dunas(1), nibergen_squad(1), dunas2(1), core_blaze(1), aufheben(1), cwkpq(1), tokyo_2095(1), vonleon(1), scartar(1), cygnus(1), hilla(1), darkhilla(1), arkarium(1);
