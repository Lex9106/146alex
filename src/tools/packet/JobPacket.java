...
public class JobPacket {
    ...
    public static class WindArcherPacket{
        ...
        public static byte [] StormBringer(int cid, int skillid, int ga, int oid, int gu) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.GAIN_FORCE.getValue());
        mplew.write(0);
        mplew.writeInt(cid);
        mplew.writeInt(8);//Storm Bringer Arrow Effect
        mplew.write(1);
        mplew.writeInt(oid);
        mplew.writeInt(skillid);
            mplew.write(1);//idk
            ...
            mplew.writeInt(1);
            mplew.writeInt(0);
            mplew.writeInt(7);//it seems its dmg
            mplew.writeInt(0);
            mplew.writeInt(0);
            mplew.writeInt(0);
            mplew.writeLong(0);
    ...
    public static byte [] QuiverCartridge(int cid, int skillid, int ga, int oid, int gu) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.GAIN_FORCE.getValue());
        mplew.write(0);
        mplew.writeInt(cid);
        mplew.writeInt(10);//Storm Bringer Arrow Effect
        mplew.write(1);
        mplew.writeInt(oid);
        mplew.writeInt(skillid);
            mplew.write(1);//idk
    ...
    public static byte [] FinalAttack(int cid, int skillid, int ga, int oid, int gu) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.GAIN_FORCE.getValue());
        mplew.write(0);
        mplew.writeInt(cid);
  ...
  /* public static byte [] QuiverCartridge(int cid, int skillid, int ga, int oid, int gu) {
    ...
    public static class AngelicPacket {
        ...
        public static byte[] SoulSeeker2(int cid, List<Integer> moblist) {
         MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
    ...
    public static class LuminousPacket {
        ...
        public static byte[] giveCrescendo(short amount) {
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

            mplew.writeShort(SendPacketOpcode.GIVE_BUFF.getValue());
            PacketHelper.writeSingleMask(mplew, MapleBuffStat.DARK_CRESCENDO);

            mplew.writeShort(amount);
            mplew.writeInt(27121005); //skill id
        ...
        public static byte[] giveLuminousState(int skill, int light, int dark, int duration) {
            ...
            mplew.writeInt(light); //light gauge
            mplew.writeInt(dark); //dark gauge
            mplew.writeInt(1);
