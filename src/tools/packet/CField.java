...
import static tools.packet.PacketHelper.addAbilityInfo;
import static tools.packet.PacketHelper.addHonorInfo;
...
public class CField {
    ...
    public static byte[] getCharInfoInner(MapleCharacter chr) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//                mplew.writeInt(Integer.MAX_VALUE);
    ...
    public static byte[] enchantResult(int result, MapleClient c) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] sendSealedBox(short slot, int itemId, List<Integer> items) { 
        ...
        mplew.writeInt(items.size()); 
        for (int item : items) { 
            mplew.writeInt(items.get(Randomizer.nextInt(items.size()))); 
        } 
