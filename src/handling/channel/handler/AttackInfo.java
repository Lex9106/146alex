...
public class AttackInfo {
    ...
    public final MapleStatEffect getAttackEffect(final MapleCharacter chr, int skillLevel, final Skill skill_) {
        if (GameConstants.isMulungSkill(skill) || GameConstants.isPyramidSkill(skill) || GameConstants.isInflationSkill(skill) || GameConstants.isInflationSkill2(skill)) {
            skillLevel = 1;
            chr.dropMessage(-5,"Inflation skill id is " + skill);
